...
<div class="col-lg-12"style="float: left;padding-top: 30px">
    <h2 class="title-1 m-b-25" >Deleted Course</h2>
                        ...
                        <tr>
                            ...
                            <th>
                                <form action="${path}/tutor/manager/course" method="post">
                                    <input type="hidden" name="Request" value="Recover" />
                                    <input type="hidden" name="NowPage" value="DeletedPage" />
                                    <input type="hidden" name="txtCourseID" value="${x.getCourseID()}"/>
                                    <button class="btn btn-secondary btn-sm" style="background-color: #cd2737;border-radius: 10px;margin: 5px;padding: 10px" type="submit">Recover</button>
                                </form>
                            </th>
